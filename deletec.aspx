<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deletec.aspx.cs" Inherits="CS322" EnableSessionState=true%>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Delete: Final LP2 Project</title>
    <style>
      body{
...
<body>
    ...
    <h3>Click "Delete" to remove your record for CS322 Content table  database!</h3>
    <asp:Button id="update" onclick="btnSubmit_Click_one" runat="server" Text="Delete"></asp:Button>
     ...
     <asp:Panel ID="panel4" runat="server" Wrap="true" Visible="false">
      <h2>Select a record to delete from CS322 Content Database!!</h2>
    ...
    <asp:Panel ID="panel6" runat="server" Wrap="true" Visible="false"> 
            <h2> <a href="deletec.aspx">Click here delete another record :'( </a></h2>
        </asp:Panel>    
