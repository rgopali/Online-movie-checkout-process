...
public void btnSubmit_update_record(Object Src, EventArgs E)
    ...
    "MultipleActiveResultSets = True";
      ...
      command = new SqlCommand("UPDATE adm_tbl SET adm_username =@username, adm_password=@password, adm_fname=@firstname, adm_lname=@lastname WHERE adm_id=@id", connection);
